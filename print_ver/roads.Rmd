...
```{r road-figures, out.width = "55%"}

road_bar <- "soe_roads_by_surface.png"
road_map <- "soe_roads_map.png"
include_graphics(paste0(proj_path, road_bar))
...
```{r roadless-area-figures, out.width = "55%"}

areas_bar <- "figures/Province_barchart.png"
areas_map <- "figures/Province_map.png"
include_graphics(paste0(proj_path, areas_bar))
include_graphics(paste0(proj_path, areas_map))
```
...
## Load list of plots for the appendix
plot_list <- readRDS(paste0(rds_path, "plotlist.rds"))
plot_list <- plot_list[names(plot_list) != "Province"]

#foo <- plot_list[1:4] #object for testing iwalk()
